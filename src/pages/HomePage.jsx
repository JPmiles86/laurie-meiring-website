            ...
            <div style={{ 
              ...
              >
                ...
                <div className="card-content" style={{ 
                  ...
                  <h3 style={{ fontSize: '2rem', marginBottom: '15px' }}><strong>Certified Coaching in the Jungle of Ojochal</strong></h3>
                  <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '25px' }}>
                  Train with a tournament champion and <em>PiclUp Certified Coach</em> under Senior Pro Rich Lively's program. Whether you're stepping onto the court for the first time or preparing for high-level competition, elevate your game with proven progression-based methods, personalized strategy, and world-class coaching.
                  </p>
        ...
        <div style={{ 
          ...
          <div className="content-container">
            <div style={{ 
              ...
              >
                Laurie Meiring is a tournament champion and <em>PiclUp Certified Coach</em> trained under Senior Pro Rich Lively.
                Based in Ojochal, Costa Rica, he offers personalized coaching and guided pickleball experiences
                designed to elevate your game and create unforgettable memories.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
